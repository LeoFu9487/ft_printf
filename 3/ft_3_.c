...
static void	ft_3__0(t_form form, int *cnt)
{
...
static void	ft_3__1_0(t_form form, int *cnt)
{
...
static void	ft_3__1_1(t_form form, int *cnt, int *ct)
{
...
static void	ft_3__1(t_form form, int *cnt, int *ct)
{
	ct[2] = 1;
	while (ct[1] > 9 || ct[1] < -9)
	{
...
void		ft_3_(t_form form, va_list *arg, int *cnt)
{
	...
	ct[1] = ct[0] = va_arg(*arg, int);
	if (ct[0] == 0 && form.precision == 0)
		ft_3__0(form, cnt);
	else
		ft_3__1(form, cnt, (int*)ct);
}