...
static void	ft_3_3_0(t_form form, int *cnt)
{
...
static void	ft_3_3_1_0(t_form form, int *cnt)
{
...
static void	ft_3_3_1_1(t_form form, int *cnt, int *ct)
{
...
static void	ft_3_3_1(t_form form, int *cnt, int *ct)
{
	ct[2] = 1;
	while (ct[1] > 9 || ct[1] < -9)
	{
...
void		ft_3_3(t_form form, va_list *arg, int *cnt)
{
	...
	x = (signed char)va_arg(*arg, int);
	ct[0] = (int)x;
	ct[1] = (int)x;
	if (ct[0] == 0 && form.precision == 0)
		ft_3_3_0(form, cnt);
	else
		ft_3_3_1(form, cnt, (int*)ct);
}